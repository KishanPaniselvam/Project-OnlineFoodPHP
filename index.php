        ...
        <header id="header" class="header-scroll top-header headrom">
            <nav class="navbar navbar-dark">
                <div class="container">
                    ...
                    <a class="navbar-brand" href="index.php"> <img class="img-rounded" src="images/fashion.png" alt="" width="120" height="70"> </a>
                    <div class="collapse navbar-toggleable-md  float-lg-right" id="mainNavbarCollapse">
                        <ul class="nav navbar-nav">
                            <li class="nav-item"> <a class="nav-link active" href="index.php">Home <span class="sr-only">(current)</span></a> </li>
                            <li class="nav-item"> <a class="nav-link active" href="restaurants.php">Restaurants <span class="sr-only"></span></a> </li>
							<li class="nav-item"> <a class="nav-link active" href="index.html">About Us <span class="sr-only"></span></a></li>
							<li class="nav-item"> <a class="nav-link active" href="feedbackform.html">FeedBack<span class="sr-only"></span></a></li>
        ...
        <section class="popular">
            <div class="container">
                <div class="title text-xs-center m-b-30">
                    <h2>Top 3 Monthly Favorites</h2>
                    <p class="lead">Streamlined Ordering for Your Favorite Meals</p>
                </div>
                <div class="row">
						<?php 					
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-12 text-center">
						...
						<p class="pay-info">Card Payment</p>
						<p class="pay-info">Online Banking</p>
                    </div>
                </div>
            </div>
        </section>
                ...
                <div class="bottom-footer">
                    <div class="row">
                        ...
                        <div class="col-xs-12 col-sm-4 address color-gray">
                                    <h5>Address</h5>
                                    <p><b>Jalan Bukit Sebukor, Bukit Baru, 75150 Melaka International College of Yayasan Melaka (ICYM), address</p>
                                    <h5>Contact Us</a></h5>
